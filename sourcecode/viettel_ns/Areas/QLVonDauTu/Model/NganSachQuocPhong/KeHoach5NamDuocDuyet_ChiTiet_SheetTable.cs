...
namespace VIETTEL.Areas.QLVonDauTu.Model.NganSachQuocPhong
{
    public class KeHoach5NamDuocDuyet_ChiTiet_SheetTable : SheetTable
    {
        ...
        public KeHoach5NamDuocDuyet_ChiTiet_SheetTable(string iID_KeHoach5NamID, int iNamLamViec, int iGiaiDoanTu, Dictionary<string, string> query, List<KeHoach5NamChiTietDuocDuyetTempForSave> listKHVChiTiet, DataTable currentShowingList)
        {
        ...
        private void fillSheet(string iID_KeHoach5NamID, int iNamLamViec, Dictionary<string, string> filters, List<KeHoach5NamChiTietDuocDuyetTempForSave> listKHVChiTiet, DataTable currentShowingList)
        {
            ...
            else
            {
                ...
                foreach (DataRow r in currentShowingList.Rows)
                {

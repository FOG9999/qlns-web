SELECT dt.iID_DuAn_ChiPhi, cp.sTenChiPhi, cp.iID_ChiPhi as iID_ChiPhiID, cp.iID_ChiPhi_Parent, CAST(0 as float) as fTienPheDuyet,
		CAST(0 as float) as fGiaTriDieuChinh, dt.fTienPheDuyet as fTienPheDuyetQDDT, dmcp.iThuTu as iThuTu, CAST(0 as bit) as isDelete
...
LEFT JOIN VDT_DM_ChiPhi dmcp ON cp.iID_ChiPhi = dmcp.iID_ChiPhi

...
function Luu() {
    if (CheckLoi()) {
        ...
        quyetToan.fChiPhiThietHai = parseFloat(UnFormatNumber($("#fChiPhiThietHai").val()));
        quyetToan.fChiPhiKhongTaoNenTaiSan = parseFloat(UnFormatNumber($("#fChiPhiKhongTaoNenTaiSan").val()));
        quyetToan.fTaiSanDaiHanThuocCDTQuanLy = parseFloat(UnFormatNumber($("#fTaiSanDaiHanThuocCDTQuanLy").val()));
        quyetToan.fTaiSanDaiHanDonViKhacQuanLy = parseFloat(UnFormatNumber($("#fTaiSanDaiHanDonViKhacQuanLy").val()));
        quyetToan.fTaiSanNganHanThuocCDTQuanLy = parseFloat(UnFormatNumber($("#fTaiSanNganHanThuocCDTQuanLy").val()));
        quyetToan.fTaiSanNganHanDonViKhacQuanLy = parseFloat(UnFormatNumber($("#fTaiSanNganHanDonViKhacQuanLy").val()));

...
function loadDataExcel() {
    ...
    $.ajax({
        type: "POST",
        url: "/QLVonDauTu/QLThongTinGoiThau/LoadDataExcel",
        data: formData,
        contentType: false,
        processData: false,
        cache: false,
...
function LoadGrid() {
    ...
    lstData.forEach(function (obj, index) {
        ...
        strHtml.push("<td style='text-align:center'>" + obj.sSoQuyetDinh + "</td>");
        strHtml.push("<td style='text-align:center'>" + obj.sNgayQuyetDinh + "</td>");
        strHtml.push("<td>" + obj.sTenGoiThau + "</td>");
        ...
        strHtml.push("<td style='text-align:right'>" + obj.fTienTrungThau + "</td>");
        strHtml.push("</tr>");
    });
...
function SaveDataImport() {
    $.ajax({
        type: "POST",
        url: "/QLVonDauTu/QLThongTinGoiThau/OnSaveDataImport",
        data: { lstData: lstData },
        success: function (r) {
            if (r.bIsSuccess) {
                alert("Import thành công !");
                location.href = "/QLVonDauTu/QLThongTinGoiThau";
            } else {

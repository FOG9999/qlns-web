...
namespace VIETTEL.Areas.QLNH.Controllers.CPNH
{
    public class TongHopKinhPhiDuocCapController : FlexcelReportController
    {
        ...
        public ActionResult Index()
        {
            ...
            List<CPNHThucHienNganSach_Model> list = _cpnhService.getListKinhPhiDuocCapTheoDonViModels(1, DateTime.Now.Year, null).ToList();
        ...
        [HttpPost]
        public ActionResult TongHopKinhPhiDuocCapSearch(int? iQuyList, int? iNam, Guid? iDonvi)
        {
            CPNHThucHienNganSach_ModelPaging vm = new CPNHThucHienNganSach_ModelPaging();

            ...
            list = new List<SheetColumn>()
                {
                    ...
                    new SheetColumn(columnName: "sTenDonViQL", header: "Đơn vị thực hiện dự án", columnWidth:200, align: "left", isReadonly: true),
                    new SheetColumn(columnName: "sTenChuDauTu", header: "Tên chủ đầu tư", columnWidth:200, align: "left", isReadonly: true),
                    new SheetColumn(columnName: "sMaDuAn", header: "Mã dự án", columnWidth:200, align: "left", isReadonly: true),
                    new SheetColumn(columnName: "sSoQuyetDinhCTDT", header: "Số chủ trương đầu tư", columnWidth:200, align: "left", isReadonly: true),
